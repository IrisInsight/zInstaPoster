  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-[380px]">
        ...
        >
          <h1 className="text-[15px] font-semibold">Enter your access code</h1>
          <p className="mt-1 text-[13px] text-[var(--color-muted)]">
            Internal tool. One code for the team, handed out by the operator.
          </p>
          ...
          <label className="mt-4 block text-[12px] font-medium text-[var(--color-muted)]">
            ...
            <input
              ...
              spellCheck={false}
              className="mt-1 w-full rounded-md border border-[var(--color-line)] px-2.5 py-2 text-[15px] tracking-[0.18em] text-[var(--color-ink)]"
            />
          </label>
